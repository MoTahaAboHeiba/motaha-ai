...
Mohamed Taha built this E-Commerce Lakehouse to demonstrate how Databricks and
Delta Lake can turn disconnected source data into an analytics-ready model.
...
- [E-Commerce Lakehouse — Databricks Medallion Architecture](#e-commerce-lakehouse--databricks-medallion-architecture)
...
![Data Lineage](./Docs/Data_Lineage_Diagram.jpg)
...
![ETL Pipeline DAG](./Docs/ETL_Pipeline_DAG.jpeg)
